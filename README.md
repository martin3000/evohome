...
You _could_ run it alongside the existing `honeywell.py` component (why would you want to?). To run it in tandem with the builtin `evohome.py`componenet, you'd have to change its name (instructions here: https://github.com/zxdavb/evohome/issues/10).  
